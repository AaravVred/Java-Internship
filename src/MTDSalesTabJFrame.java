 ...
 * @author aarav
 */
public class MTDSalesTabJFrame extends javax.swing.JFrame {

    /**
     * Creates new form WTDSalesTabJFrame
     */
    public MTDSalesTabJFrame() {
        initComponents();
        showData();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Month to Date Sales");
  ...
  { 
    ...
    Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/salesreporting","root","Tulip");  
       ...
       String sql = "select customer_name, product_name, round(sum(sales_amt)), sum(sales_units)\n" +
                    "from sales\n" +
                    "where Year(inv_date)=Year(NOW()) and Month(inv_date) = Month(NOW())\n" +
